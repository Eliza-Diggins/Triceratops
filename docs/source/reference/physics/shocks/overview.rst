...
The shock module provided in Trilobite is designed to allow users to efficiently design models of
...
shock physics we make available in Trilobite and to understand how to use these tools to build their own models.
...
At the lowest-level of the shock physics module, Trilobite provides :mod:`~trilobite.dynamics.shocks.core`, which
...
At the core of the Trilobite shock physics module are the shock engines, which are responsible for
