...
# ------------------------------------
#
# Combining variation in both :math:`B` (colormap) and :math:`R` (linestyle)
# shows how the full SED shape shifts.  Stronger :math:`B` moves all break
# frequencies to higher values; larger :math:`R` boosts the overall flux.
