...
See Also
--------
:mod:`trilobite.dynamics.accretion.one_zone.base` :
...
from trilobite.dynamics.accretion.one_zone._typing import _RunParams
from trilobite.dynamics.accretion.one_zone.base import OneZoneAccretionDiskBase
from trilobite.physics_utils import IdealGasEOS, RadiativeIdealGas
...
class GasPressureDisk(OneZoneAccretionDiskBase):
    ...
    #: Ordered mapping of output field names to their column indices in the result array.
    ...
    def __init__(self, mu: float = 0.6, opacity: str = "electron_scattering", fallback: bool = False):
        ...
        mu : float, optional
            ...
            Default ``0.6``.
        opacity : str or ~trilobite.radiation.opacity.grey_opacity.base.GreyOpacityLaw, optional
            ...
            A :class:`~trilobite.radiation.opacity.grey_opacity.base.GreyOpacityLaw` instance
