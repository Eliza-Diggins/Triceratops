...
See Also
--------
:mod:`trilobite.dynamics.accretion.one_zone.core` :
    ...
    **Implementing a new model**
    ...
    def process_runtime_parameters(self, runtime_parameters: _ParamDict) -> _RunParams:
        ...
        - Unit-bearing values are converted to ``"base_units"`` via
          :func:`~trilobite.utils.misc_utils.ensure_in_units`.
    ...
    def _build_cython_closure(self):
        ...
        Returns
        -------
        ~trilobite.dynamics.accretion.one_zone.closure.OneZoneClosure
    ...
    def to_spec_dict(self) -> dict:
        ...
        """
        return {
            "target": f"trilobite.dynamics.accretion.one_zone.core:{self.__class__.__name__}",
    ...
    def solve_parameter_grid(
        ...
        for combo in tqdm(
            ...
            disable=trilobite_config["system.appearance.disable_progress_bars"],
        ):
    ...
    **HDF5 persistence**
    ...
    def to_hdf5(self, filename: _FilePath, overwrite: bool = False) -> None:
        ...
        **File layout**::
            ...
            ├── [attr] version     : str  (trilobite package version)
    ...
    def compute_accretion_luminosity(self, time: Any, interpolator=None, **interp_kwargs) -> u.Quantity:
        ...
        .. note::
            ...
            models (e.g. :class:`~trilobite.dynamics.accretion.one_zone.core.AdvectiveDisk`)
