...
This module defines the :class:`~trilobite.inference.problem.InferenceProblem` abstract base class, which serves as a
template for defining specific inference problems in the Trilobite library. It takes, as input, a
:class:`~trilobite.inference.likelihood.base.Likelihood` instance and allows the user to handling things like fixed
and
...
if TYPE_CHECKING:
    from trilobite._typing import _UnitBearingScalarLike
    from trilobite.inference.likelihood.base import Likelihood
    from trilobite.models._typing import _ModelParametersInput
    from trilobite.models.core.base import Model
    from trilobite.models.core.parameters import BoundType, ModelParameter
...
class InferenceParameter:
    ...
    When an :class:`~trilobite.inference.problem.InferenceProblem` is initialized, it
    creates an :class:`~trilobite.inference.problem.InferenceParameter`
    object for each of the parameters defined in the corresponding :class:`~trilobite.models.core.base.Model` provided
    as part of the input :class:`~trilobite.inference.likelihood.base.Likelihood` object.

    Parameters
    ----------
    model_parameter: `~trilobite.models.core.parameters.ModelParameter`
        ...
        selected from the model's :attr:`~trilobite.models.core.base.Model.PARAMETERS` list. Because
        :class:`~trilobite.inference.problem.InferenceParameter`
        instances are generated automatically during :class:`~trilobite.inference.problem.InferenceProblem`
    ...
    """~trilobite.models.core.parameters.ModelParameter: The model parameter associated with this inference parameter.
    ...
    prior: "Prior" = None
    r""":class:`~trilobite.inference.prior.Prior`: Prior distribution for this parameter.
    ...
    If a :class:`~trilobite.inference.prior.Prior` instance is provided,
    its :meth:`~trilobite.inference.prior.Prior.logp` method is used to
    ...
    - Custom priors must be importable and JSON-serializable
      in order for :class:`~trilobite.inference.problem.InferenceProblem` serialization
      to remain fully reconstructible.
    """
    transform: "ParameterTransform" = None
    r""":class:`~trilobite.inference.transform.ParameterTransform`: Optional transformation applied
    ...
    def to_dict(self) -> dict:
        """
        Serialize the :class:`~trilobite.inference.problem.InferenceParameter` to a JSON-safe dictionary.
    ...
    def from_dict(
        ...
        """
        Reconstruct an :class:`~trilobite.inference.problem.InferenceParameter` from a serialized dictionary.
        ...
        """
        from trilobite.inference.prior import Prior
        from trilobite.inference.transform import ParameterTransform
...
class InferenceProblem:
    ...
    An :class:`~trilobite.inference.problem.InferenceProblem` defines the **glue layer** between a physical
    :class:`~trilobite.models.core.base.Model`, observational data, and a statistical
    ...
    - **Parameter management**
        Each model parameter is wrapped in an :class:`~trilobite.inference.problem.InferenceParameter`,
    ...
    - **Likelihood evaluation**
        ...
        :class:`~trilobite.inference.likelihood.base.Likelihood` object, which encapsulates
    ...
    Design philosophy
    -----------------
    The :class:`~trilobite.inference.problem.InferenceProblem` enforces a clear separation of concerns:
    ...
    Trilobite ensures that inference logic remains transparent, reproducible,
    and extensible.

    Intended usage
    --------------
    Users typically do not instantiate :class:`~trilobite.inference.problem.InferenceProblem` directly.
    ...
    - This class does not store sampling results; results are handled by
      classes in :mod:`trilobite.inference.sampling`.
    ...
    trilobite.inference.sampling
        Samplers that operate on :class:`~trilobite.inference.problem.InferenceProblem` instances.
    """
    ...
    def __init__(self, likelihood: "Likelihood", *_, **__):
        """
        Initialize the :class:`~trilobite.inference.problem.InferenceProblem` object.

        Parameters
        ----------
        likelihood: `~trilobite.inference.likelihood.base.Likelihood`
    ...
    def likelihood(self) -> "Likelihood":
        """`~trilobite.inference.likelihood.base.Likelihood`: The likelihood associated with this inference problem.

        The :class:`~trilobite.inference.likelihood.base.Likelihood` object defines the model and data
        for the problem and,
    ...
    def model(self) -> "Model":
        """`~trilobite.models.core.base.Model`: The model associated with this inference problem."""
    ...
    def data(self):
        ...
        defined in the :mod:`trilobite.data` module.
        """
    ...
    def to_dict(self, **extra_metadata) -> dict:
        """
        Serialize the :class:`~trilobite.inference.problem.InferenceProblem` to a fully reconstructible dictionary.
        ...
        **extra_metadata
        ...
        metadata_block = {
            ...
            "trilobite_version": __pkg_version__,
        }
    ...
    def from_dict(cls, dict_spec: dict) -> "InferenceProblem":
        """
        Reconstruct an :class:`~trilobite.inference.problem.InferenceProblem` from a serialized dictionary.
        ...
        using a different version of ``trilobite`` than the currently
        installed version.
        ...
        """
        from trilobite.data.core import InferenceData
        from trilobite.models.core.serial import ModelSpec
        ...
        # Extract the trilobite version and check it against current. If
        # it is not the same version, we raise a warning.
        spec_version = dict_spec["metadata"].get("trilobite_version")
        if spec_version != __pkg_version__:
            warnings.warn(
                f"Version mismatch: InferenceProblem specification was created with trilobite "
    ...
    def to_json(self, path: Optional[str] = None, **extra_metadata) -> str:
        """
        Serialize the :class:`~trilobite.inference.problem.InferenceProblem` to a JSON string or file.
    ...
    def from_json(cls, source: Union[str, bytes]) -> "InferenceProblem":
        """
        Reconstruct an :class:`~trilobite.inference.problem.InferenceProblem` from a JSON string or file.
    ...
    def to_yaml(self, path: Optional[str] = None, **extra_metadata) -> str:
        """
        Serialize the :class:`~trilobite.inference.problem.InferenceProblem` to a YAML string or file.
    ...
    def from_yaml(cls, source: Union[str, bytes]) -> "InferenceProblem":
        """
        Reconstruct an :class:`~trilobite.inference.problem.InferenceProblem` from a YAML string or file.
