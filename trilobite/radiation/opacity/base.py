"""Abstract base class for Trilobite opacity laws.

This module provides the core base class for generic opacity laws in Trilobite:
:class:`~trilobite.radiation.opacity.base.OpacityLaw`.  This defines the public unit-bearing
...
class OpacityLaw:
    ...
    methods on the Cython object (see :mod:`trilobite.radiation.opacity.opacity_base`).

    See Also
    --------
    ~trilobite.radiation.opacity.grey_opacity.base.GreyOpacityLaw : Subclass for frequency-averaged
     (grey) opacity laws.
    ~trilobite.radiation.opacity.opacity_base.C_OpacityBase : C-level companion class.
    """
    ...
    def _initialize_C_object(self, **parameters):
        ...
        log-space interface in :mod:`trilobite.radiation.opacity.opacity_base`.
