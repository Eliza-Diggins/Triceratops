"""
Foundational components of synchrotron modeling for trilobite.
...
.. seealso::
    ...
    :ref:`synchrotron_overview`: An overview of the synchrotron modeling framework in trilobite, including how
