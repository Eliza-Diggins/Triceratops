...
from trilobite.physics_utils.special_relativity import compute_doppler_factor
...
def _invert_powerlaw_sed(
    ...
    standard Trilobite one-zone closure assumptions.
    ...
    .. dropdown:: Assumptions and interpretation
       ...
       - the standard Trilobite microphysical closure,
...
def _invert_powerlaw_ssa_sed_demarchi(
    ...
    is distinct from the standard Trilobite single-zone inversion family.
    ...
    .. dropdown:: Applicability
       ...
       Trilobite inversion framework, use the other helpers in this
       module.
    ...
    invert_powerlaw_ssa_sed_demarchi
        Public, unit-aware wrapper.
    _invert_powerlaw_ssa_sed
        Standard Trilobite SSA inversion.
    :ref:`synch_sed_theory`
...
def invert_powerlaw_sed(
    ...
    field strength :math:`B` under the standard Trilobite one-zone
    closure assumptions.
...
def invert_powerlaw_ssa_sed_demarchi(
    ...
    *,
    ...
    Notes
    -----
    This closure is separate from the main Trilobite single-zone inversion
