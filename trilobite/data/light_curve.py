...
class RadioLightCurveContainer(XYDataContainer):
    ...
    def to_inference_data(
        ...
        r"""
        Convert this :class:`RadioLightCurveContainer` into an :class:`~trilobite.data.core.InferenceData` object.
...
class OpticalLightCurveContainer(XYDataContainer):
    ...
    **AB magnitudes**, or both. The container exposes both representations
    ...
    from trilobite.utils.phot_utils import ab_mag_to_flux as _ab_mag_to_flux
    from trilobite.utils.phot_utils import flux_to_ab_mag as _flux_to_ab_mag
    ...
    def flux(self) -> u.Quantity:
        ...
        from trilobite.utils.phot_utils import ab_mag_to_flux
    ...
    def mag(self) -> np.ndarray:
        ...
        from trilobite.utils.phot_utils import flux_to_ab_mag
    ...
    def to_inference_data(
        ...
        r"""
        Convert this :class:`OpticalLightCurveContainer` to an :class:`~trilobite.data.core.InferenceData` object.
